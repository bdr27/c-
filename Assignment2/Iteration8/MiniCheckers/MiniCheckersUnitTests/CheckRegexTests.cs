...
namespace MiniCheckersUnitTests
{
    ...
    public class CheckRegexTests
    {
        ...
        [TestMethod]
        public void CheckValidGameStart()
        {
            Assert.IsTrue(CheckRegex.CheckValidGameStart("GAMESTART,john,jill"));
        }

        [TestMethod]
        public void CheckValidGameState()
        {
            Assert.IsTrue(CheckRegex.CheckValidGameState("GAMESTATE,N11N22|N44N55"));
        }

        [TestMethod]
        public void CheckValidTryTest()
        {
            Assert.IsTrue(CheckRegex.CheckValidTry("TRY,john,N12,N23"));
        }
    }
}
