...
namespace ClientMiniCheckers
{
    ...
    public partial class App : Application
    {
        ...
        private Thread RequestResponseThead;
        ...
        {
            RequestResponseThead = new Thread(new ThreadStart(RequestResponseBackground_Thread));
            RequestResponseThead.IsBackground = true;
        }
